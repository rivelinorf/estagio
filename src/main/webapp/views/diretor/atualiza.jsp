...
<%
    DiretorFiltroVO vo = (DiretorFiltroVO) session.getAttribute("diretorParaEditar");
...
<div class="main">
    <sge:header titulo="Editar diretor" actionSalvar="true"
                actionLimpar="/diretor/preenche-vo"
                formId="edit-form" actionFechar="true">
    </sge:header>

    <div class="div-form">
        <form action="/atualiza-diretor?id=<%=vo.getId()%>" method="post"
              id="edit-form">
                ...
                <div class="form-row">
                    ...
                    <select name="escola" class="form-control">
                        ...
                        <c:forEach items="${escolaController.all}" var="escola">
                            <c:choose>
                                <c:when test="${escola.id == diretorParaEditar.funcionario.escola.id}">
