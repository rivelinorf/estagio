...
public class Atualiza extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (errosEscola.size() == 0) {
            ...
            if (verifica.size() == 0) {
                escolaController.update(novaEscola);
                ...
                session.setAttribute("filtroLogradouro_insereEndereco", logradourovo);
                RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/escola/atualiza.jsp");
